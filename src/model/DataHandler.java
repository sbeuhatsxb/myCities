...
public class DataHandler {
    ...
    public static void createTables() {
        ...
        String[] styles = {"Architecture_en_béton", "Architectureenbéton", "Architecture_en_bois", "Architectureenbois", "Architecture_ottomane", "Architecture_ottomane", "Architectureottomane", "Architectureparpériode", "Architecture_traditionnelle", "Architecture_traditionnelle", "Architecturetraditionnelle", "Artdéco",
                "Art_nouveau", "Architecture_Art_nouveau", "Architecture_baroque", "Bauhaus", "Architecture_brutaliste", "Architecture_byzantine", "Architecture_carolingienne", "Architecture_classique", "Architecture_coloniale",
                "Architecture_constructiviste", "Architecture_déconstructiviste", "Architecture_éclectique", "Architecture_expressionniste",
                "Architecture_futuriste", "Architecture_gothique", "Gothique_isabélin", "Architecture_high-tech", "Architecture_industrielle", "Architecture_maniériste",
                "Style_manuélin", "Style_architectural_médiéval", "Architecture_métaboliste", "Architecture_métallique",
                "Architecture_moderne", "Architecture_mudéjare", "Architecture_néo-baroque", "Architecture_néo-byzantine",
                "Architecture_néoclassique", "Architecture_néo-gothique", "Architecture_néo-mauresque", "Architecture_néo-renaissance", "Architecture_néo-romane",
                "Architecture_néo-russe", "Architecture_paléochrétienne", "Postmodernisme_(architecture)", "Architecture_régionaliste",
                "Architecture_romano-byzantine", "Architecture_stalinienne", "Style_international", "Style_architectural_tibétain", "Architecture_totalitaire",
        ...
        String[] materials = {"plâtre", "ciment", "chaux", "brique", "bloc", "pavé", "tuile", "ardoise", "carreau", "bardeau", "panneau de menuiserie", "produit étirés", "verre étiré", "feuille d'acier", "feuille de plomb", "feuille de zinc", "membranes synthétique", "produit laminés", "poutrelles", "barres", "fils en acier ou fer forgé"};
